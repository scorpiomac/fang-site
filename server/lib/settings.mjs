...
export const DEFAULT_SETTINGS = {
  ...
  payments: {
    methods: [
      { id: "whatsapp", label: "WhatsApp atelier", active: false, instructions: "" },
      { id: "bank", label: "Virement bancaire", active: false, instructions: "" },
      { id: "wave", label: "Wave", active: true, instructions: "Paiement mobile sécurisé via Wave." },
      { id: "orange_money", label: "Orange Money", active: true, instructions: "Paiement mobile sécurisé via Orange Money." },
      { id: "card", label: "Carte bancaire", active: true, instructions: "Visa, Mastercard et cartes internationales." },
    ],
  },
  checkout: {
