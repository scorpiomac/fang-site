...
export const CMS_SCHEMA = {
  sections: [
    ...
    {
      id: "home.story",
      label: "Accueil — Philosophie",
      icon: "✺",
      lede: "Bloc philosophie : introduction, titres des cartes et citation de clôture.",
      fields: [
        { id: "intro", label: "Texte d'introduction", type: "textarea", rows: 3 },
        {
          id: "fragments",
          label: "Titres des cartes",
          type: "list",
          itemLabel: "Titre",
          hint: "Un titre par carte (01 à 05). Les descriptions restent dans le code.",
        },
        { id: "footerQuote", label: "Citation de clôture", type: "textarea", rows: 2 },
      ],
    },
    {
      id: "home.chapters",
...
export const CMS_DEFAULTS = {
  ...
  "home.story": {
    ...
    footerQuote: "FANG, ce n'est pas une norme. C'est une liberté.",
  },
  "home.chapters": {
