...
export const recognition = {
  ...
  vision:
    "D’ici cinq ans, FANG est une grande maison de mode capable de rivaliser avec les plus grandes — pas par imitation, mais par essence. Sénégal, Paris, Londres, New York, Tokyo.",
} as const;
